...
#define RDM_UID_TRUE (dr_line->buffer.rx_buf[i+3] == ((dr_line->rdm_line.device_info.uid >> 5*8) & 0xFF) &&   \
                      dr_line->buffer.rx_buf[i+4] == ((dr_line->rdm_line.device_info.uid >> 4*8) & 0xFF) &&   \
                      dr_line->buffer.rx_buf[i+5] == ((dr_line->rdm_line.device_info.uid >> 3*8) & 0xFF) &&   \
                      dr_line->buffer.rx_buf[i+6] == ((dr_line->rdm_line.device_info.uid >> 2*8) & 0xFF) &&   \
                      dr_line->buffer.rx_buf[i+7] == ((dr_line->rdm_line.device_info.uid >> 1*8) & 0xFF) &&   \
                      dr_line->buffer.rx_buf[i+8] == ((dr_line->rdm_line.device_info.uid >> 0*8) & 0xFF)) ||  \
                     (dr_line->buffer.rx_buf[i+3] == 0xFF &&                                           \
                      dr_line->buffer.rx_buf[i+4] == dr_line->buffer.rx_buf[i+3] &&            \
                      dr_line->buffer.rx_buf[i+5] == dr_line->buffer.rx_buf[i+4] &&            \
                      dr_line->buffer.rx_buf[i+6] == dr_line->buffer.rx_buf[i+5] &&            \
                      dr_line->buffer.rx_buf[i+7] == dr_line->buffer.rx_buf[i+6] &&            \
                      dr_line->buffer.rx_buf[i+8] == dr_line->buffer.rx_buf[i+7])   
