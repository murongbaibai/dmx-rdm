...
{
    // 设置广播地址
    rdm_package_set_uid(RDM_BROADCAST_ADDR);
...
void rdm_disc_mute(dr_line_t *dr_line, uid_t *p)
{
    ...
    rdm_package_set_cmd(0x10, 0x0002);  // DISC_MUTE命令
...
void rdm_disc_un_mute(dr_line_t *dr_line, uid_t *p)
{
    ...
    rdm_package_set_uid(p->uid);
    rdm_package_set_cmd(0x10, 0x0003);  // DISC_UN_MUTE命令
    rdm_package_set_data(0, NULL);
    rdm_package_send(dr_line);
}
...
void rdm_get_version(dr_line_t *dr_line, uid_t *p)
{
    ...
    rdm_package_set_uid(p->uid);
    rdm_package_set_cmd(0x20, 0x00C0);  // GET_DEVICE_VERSION命令
    rdm_package_set_data(0, NULL);
    rdm_package_send(dr_line);
}
...
void rdm_get_info(dr_line_t *dr_line, uid_t *p)
{
    ...
    rdm_package_set_uid(p->uid);
    rdm_package_set_cmd(0x20, 0x0060);  // GET_DEVICE_INFO命令
    rdm_package_set_data(0, NULL);
    rdm_package_send(dr_line);
}
...
void rdm_get_flag(dr_line_t *dr_line, uid_t *p)
{
    ...
    rdm_package_set_uid(p->uid);
    rdm_package_set_cmd(0x20, 0x1000);  // GET_DEVICE_FLAG命令
    rdm_package_set_data(0, NULL);
    rdm_package_send(dr_line);
}
...
void rdm_set_flag(dr_line_t *dr_line, uid_t *p)
{
    ...
    rdm_package_set_uid(p->uid);
    rdm_package_set_cmd(0x30, 0x1000);  // SET_DEVICE_FLAG命令
...
void rdm_get_dmx_addr(dr_line_t *dr_line, uid_t *p)
{
    ...
    rdm_package_set_uid(p->uid);
    rdm_package_set_cmd(0x20, 0x00F0);  // GET_DMX_ADDRESS命令
    rdm_package_set_data(0, NULL);
    rdm_package_send(dr_line);
}
...
void rdm_set_dmx_addr(dr_line_t *dr_line, uid_t *p)
{
    ...
    rdm_package_set_uid(p->uid);
    rdm_package_set_cmd(0x30, 0x00F0);  // SET_DMX_ADDRESS命令
...
void rdm_get_mode(dr_line_t *dr_line, uid_t *p)
{
    ...
    rdm_package_set_uid(p->uid);
    rdm_package_set_cmd(0x20, 0x00E0);  // GET_DEVICE_MODE命令
    rdm_package_set_data(0, NULL);
    rdm_package_send(dr_line);
}
...
void rdm_set_mode(dr_line_t *dr_line, uid_t *p)
{
    ...
    rdm_package_set_uid(p->uid);
    rdm_package_set_cmd(0x30, 0x00E0);  // SET_DEVICE_MODE命令
...
void rdm_get_mode_info(dr_line_t *dr_line, uid_t *p)
{
    ...
    rdm_package_set_uid(p->uid);
    rdm_package_set_cmd(0x20, 0x00E1);  // GET_DEVICE_MODE_INFO命令
    rdm_package_set_data(1, &p->device_cur_mode);
    rdm_package_send(dr_line);
}
...
void rdm_output_unpack(dr_line_t *dr_line)
{
    ...
    {
        // 根据命令类型解析包
        switch(__DR_RX_BUF(dr_line)[i+20])
        {
            // 响应类命令
            case 0x11:
                if(__DR_RX_BUF(dr_line)[i+21] == 0x00 && __DR_RX_BUF(dr_line)[i+22] == 0x02)
                {
            ...
            case 0x21:
                ...
                else if(__DR_RX_BUF(dr_line)[i+21] == 0x00 && __DR_RX_BUF(dr_line)[i+22] == 0xE1)
                {
